...
#define CITIZEN_CULL_FREQ                                                                                              \
	0 // cull citizens who have been stuck longer than CITIZEN_DESPAWN_THRESH every n simulation ticks
...
// Pathfinding
#define CITIZEN_PATH_SIZE                                                                                              \
	64 // this value is not mathematically guaranteed to exceed the maximum number of possible lines in a path (but errors are handled)
...
#define TRANSFER_PENALTY_MULTIPLIER                                                                                    \
	TRAIN_SPEED / CITIZEN_SPEED // multiplier for distance walked during walking transfers
